/* ================================================================== */
/* SCRIPT FOR WIDGET 1: IMAGE GALLERY (PREFIX: qqq-) - FINAL & MOST RELIABLE */
/* ================================================================== */
(function() {
    ...
    function initQqqGallery() {
        ...
        // 2. सबसे महत्वपूर्ण सुरक्षा जांच: अगर कोई एलिमेंट नहीं मिलता है, तो स्क्रिप्ट को रोक दें।
        if (!mainImage || !galleryItemsContainer || !prevButton || !nextButton || !hqButton || !downloadButton || !shareButton) {
            console.error("QQQ Gallery Error: One or more essential HTML elements are missing. The script will not run.");
            return;
        }

        // 3. गैलरी का स्टेट (स्थिति)
        ...
        // 4. मुख्य फंक्शन जो तस्वीर दिखाता है (यह अब ऑन-डिमांड काम करता है)
        ...
        // 5. सभी बटनों के लिए इवेंट लिस्नर सेट करना
        ...
        // 6. गैलरी को शुरू करना (पहली तस्वीर दिखाना)
        displayImage(currentIndex);
    }

    // 7. स्क्रिप्ट को चलाने के लिए सबसे विश्वसनीय तरीका
    if (document.readyState === 'loading') {
        // पेज अभी लोड हो रहा है, तो DOMContentLoaded का इंतजार करें
        document.addEventListener('DOMContentLoaded', initQqqGallery);
    } else {
        // DOM पहले से ही तैयार है, तो सीधे फंक्शन चलाएं
        initQqqGallery();
    }
})();
